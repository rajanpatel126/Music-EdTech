...
function HeroSection() {
   return (
      <>
         <div className="h-auto bg-black md:h-[40rem] min-h-screen w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
            <Spotlight
            ...
            <div className="p-4 relative z-10 w-full text-center">
               ...
               <p className="mt-12 font-normal text-base md:text-lg text-neutral-300 max-w-xl mx-auto">
