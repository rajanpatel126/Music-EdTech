...
function TestimonialCards() {
   ...
   return (
      <div className="w-full dark:bg-black dark:bg-grid-white/[0.2] h-[40rem] relative flex flex-col items-center justify-center overflow-hidden">
         <h2 className="text-3xl text-center mb-32 font-bold z-10">
            Hear Our Harmony: Voices of Success
         </h2>
         <div className="flex overflow-hidden px-4 sm:px-6 lg:px-8 justify-center">
